...
function App() {
  ...
  useEffect(() => {
    const todos = JSON.parse(localStorage.getItem("practiceTodo01"))
  ...
  useEffect(() => {
    localStorage.setItem("practiceTodo01", JSON.stringify(todos))
  }, [todos])
  ...
  return (
    <TodoProvider value={{ todos, addTodo, updateTodo, deleteTodo, toggleComplete }}>
      <div className="bg-[#172842] min-h-screen py-08">
